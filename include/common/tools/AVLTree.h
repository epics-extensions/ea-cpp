...
template<class Item> const char* toString(const Item& i);
template<class Item> int sort_compare(const Item& i1, const Item& i2);
...
///   -  0 if a== b
///   - >0 if a < b  
template<class Item> int sort_compare(const Item& a, const Item& b);
