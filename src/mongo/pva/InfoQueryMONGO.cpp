...
InfoQueryMONGO::InfoQueryMONGO(){
}

PVStructurePtr InfoQueryMONGO::apply(const std::string& id, 
  ...
  if (!dbName) {
    ...
    messageField->put("InfoQueryMONGO::apply: dbName is not defined\n");
...
PVStructurePtr InfoQueryMONGO::createEmptyResult(PVStructurePtr& pvStatus){
...
PVStructurePtr InfoQueryMONGO::createResult(PVStructurePtr& pvStatus){
...
PVStructurePtr InfoQueryMONGO::createDocs(PVStructurePtr& pvStatus){
...
PVStructurePtr InfoQueryMONGO::createDoc(PVStructurePtr& pvStatus){
...
PVFieldPtr InfoQueryMONGO::createDescField(){
...
PVFieldPtr InfoQueryMONGO::createHowField(){
...
PVFieldPtr InfoQueryMONGO::createStatField(){
...
PVFieldPtr InfoQueryMONGO::createSevrField() {
...
PVStructurePtr InfoQueryMONGO::createPVSevr(int num,
					    const char* sevr,
					    bool has_value,
					    bool txt_stat){
  PVStructurePtr result;
